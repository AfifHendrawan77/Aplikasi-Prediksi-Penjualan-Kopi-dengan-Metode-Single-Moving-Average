...
<h1>Tambah Produk</h1>
  <nav>
      ...
      <li class="breadcrumb-item"><a href="<?= base_url('/owner/produk'); ?>">Produk</a></li>
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="<?= base_url('owner/Produk/simpan_produk'); ?>" method="POST" enctype="multipart/form-data">
                <div div class="mb-3">
