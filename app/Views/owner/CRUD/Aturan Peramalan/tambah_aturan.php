...
<div class="pagetitle">
  ...
  <nav>
      ...
      <li class="breadcrumb-item active">Tambah Aturan Peramaln</li>
      </ol>
  </nav>
</div><!-- End Page Title -->
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="<?= base_url('owner/Aturan_Peramalan/simpan_aturan'); ?>" method="POST">
                <div div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tahun_peramalan">
                    </div>
                    <button type="submit"  name="simpan_aturan"  class="btn btn-primary">Simpan</button>
          </form>
          <!-- Form -->
