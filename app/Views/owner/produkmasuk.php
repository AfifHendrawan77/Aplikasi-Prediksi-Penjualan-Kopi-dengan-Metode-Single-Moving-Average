    ...
    <div class="col-lg-12">
      ...
      <div class="card">
       ...
       <p></p>
          ...
          <a href="/owner/Produk_Masuk/excel_produk_masuk" type="button" class="btn btn-primary form_per"><i class="bi bi-file-earmark-pdf-fill"></i> Export Excel</a>
          <!-- Button Tambah -->
            ...
            ?>
                <tr class="text-center" >
                      ...
                      <td class="text-center">
                            <!-- Button -->
                            <a href="/owner/Produk_Masuk/hapus/<?= $row->id_masuk; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                            <!-- Button -->
                      </td>
                </tr>
            <?php
