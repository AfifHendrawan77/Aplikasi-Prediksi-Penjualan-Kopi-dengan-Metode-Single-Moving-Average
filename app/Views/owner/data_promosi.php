    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body" style="overflow-x: auto;">
          ...
          <!-- Button Tambah -->
          <a href="/owner/data_promosi/tambah_promosi" type="button" class="btn btn-success"><i class="bi bi-plus-lg"></i> Tambah Data Promosi</a>
          <!-- Button Tambah -->
            ...
            ?>
                 <tr class="text-center" >
                      ...
                      <td class="text-center form_per">
                            <!-- Button -->
                            <a href="/owner/data_promosi/edit_promosi/<?= $row['id']; ?>" type="button" class="btn btn-warning"><i class="bx bx-edit"></i></a>
                            <a href="/owner/data_promosi/hapus_promosi/<?= $row['id']; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                            <!-- Button -->
                      </td>
                </tr>
            <?php
