      ...
      <div class="card">
        <div class="card-body" style="overflow-x: auto;">
         <p></p>
          ...
          <!-- Button Tambah -->
          <a href="/owner/data_produk/tambah_produk" type="button" class="btn btn-success form_per"><i class="bi bi-plus-lg"></i> Tambah Data Produk</a>
          <!-- Button Tambah -->
            ...
            ?>
                 <tr class="text-center" >
                      ...
                      <td class="text-center form_per">
                            <!-- Button -->
                            <a href="/owner/Data_Produk/edit_produk/<?= $row['id']; ?>" type="button" class="btn btn-warning"><i class="bx bx-edit"></i></a>
                            <a href="/owner/Data_Produk/hapus_produk/<?= $row['id']; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                            <!-- Button -->
                      </td>
                </tr>
            <?php
