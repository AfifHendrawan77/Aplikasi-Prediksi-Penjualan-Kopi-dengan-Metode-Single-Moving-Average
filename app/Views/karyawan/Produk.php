    ...
    <div class="col-lg-12">
      ...
      <div class="card">
       ...
       <p></p>
          ...
          <!-- Button Tambah -->
          <a href="/karyawan/produk/tambah_produk" type="button" class="btn btn-success form_per"><i class="bi bi-plus-lg"></i> Tambah Data Produk</a>
          <a href="" onclick="window.print()" type="button" class="btn btn-primary form_per"><i class="bi bi-printer-fill"></i> Print</a>
          <a href="/karyawan/Produk/excel_produk" type="button" class="btn btn-primary form_per"><i class="bi bi-file-earmark-pdf-fill"></i> Export Excel</a>
          <!-- Button Tambah -->
