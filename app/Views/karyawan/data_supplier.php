    ...
    <div class="col-lg-12">
      ...
      <div class="card">
       ...
       <p></p>
          ...
          <!-- Button Tambah -->
          <a href="/karyawan/data_supplier/tambah_supplier" type="button" class="btn btn-success form_per"><i class="bi bi-plus-lg"></i> Tambah Data Supplier</a>
          <a href="<?= base_url(''); ?>/karyawan/produk_masuk" type="button" class="btn btn-success form_per"><i class="bi bi-plus-lg"></i> Barang Masuk</a>
          <a href="" onclick="window.print()" type="button" class="btn btn-primary form_per"><i class="bi bi-printer-fill"></i> Print</a>
          <a href="/karyawan/Data_Supplier/excel_supplier" type="button" class="btn btn-primary form_per"><i class="bi bi-file-earmark-pdf-fill"></i> Export Excel</a>
          <!-- Button Tambah -->
            ...
            ?>
                 <tr class="text-center" >
                      ...
                      <td class="text-center form_per">
                            <!-- Button -->
                            <a href="/karyawan/data_supplier/edit_supplier/<?= $row['id']; ?>" type="button" class="btn btn-warning"><i class="bx bx-edit"></i></a>
                            <!-- <a href="/karyawan/data_supplier/hapus_supplier/<?= $row['id']; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a> -->
                            <!-- Button -->
                      </td>
                </tr>
            <?php
