    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        ...
        <p></p>
          ...
          <!-- Button Tambah -->
          <a href="<?= base_url('karyawan/Data_Kategori/tambah_kategori'); ?>" type="button" class="btn btn-success"><i class="bi bi-plus-lg"></i> Tambah Data Kategori</a>
          <!-- Button Tambah -->
            ...
            ?>
                 <tr class="text-center" >
                      ...
                      <td class="text-center form_per">
                            <!-- Button -->
                            <a href="/karyawan/data_kategori/edit_kategori/<?= $row['id']; ?>" type="button" class="btn btn-warning"><i class="bx bx-edit"></i></a>
                            <a href="/karyawan/data_kategori/hapus_kategori/<?= $row['id']; ?>" type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                            <!-- Button -->
                      </td>
                </tr>
            <?php
