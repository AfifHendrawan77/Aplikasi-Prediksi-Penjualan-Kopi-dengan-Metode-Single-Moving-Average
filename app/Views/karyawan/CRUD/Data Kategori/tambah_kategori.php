...
<h1>Data Kategori</h1>
  <nav>
      ...
      <li class="breadcrumb-item"><a href="<?= base_url('/karyawan/data_kategori'); ?>">Data Kategori</a></li>
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="<?= base_url('karyawan/Data_Kategori/simpan_kategori'); ?>" method="POST" enctype="multipart/form-data">
                <div div class="mb-3">
