...
<div class="pagetitle">
  ...
  <nav>
      ...
      <li class="breadcrumb-item"><a href="<?= base_url('/karyawan/data_promosi'); ?>">Data Promosi</a></li>
    ...
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="/karyawan/Data_Promosi/update_promosi/" method="POST" enctype='multipart/form-data'>
          <?= csrf_field(); ?>
          <input type="hidden" name="id" value="<?php echo $promosi['id'] ?>">
                <div class="mb-3">
                    <img src="<?=base_url('assets/promosi/'.$promosi['berkas']);?>" width="100">
                </div>
                <div class="mb-3">
